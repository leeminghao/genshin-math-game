...
const WORLD_LAYOUT = {
  ...
  waypoints: [
    ...
    { id: 8, label: '星屑草场', x: 8800, y: 2200 },
    { id: 9, label: '回声谷口', x: 5000, y: 5400 }
  ],
  roads: [
    ...
    [[6500, 1900], [7600, 2000], [8800, 2200]],
    [[5400, 4400], [5200, 4900], [5000, 5400]]
  ],
  blobs: [
    ...
    { kind: 'ground', x: 8620, y: 2100, rx: 620, ry: 540, rot: 24, color: '#8fc97f' },
    { kind: 'ground', x: 9010, y: 2350, rx: 540, ry: 480, rot: 102, color: '#8fc97f' },
    { kind: 'ground', x: 8830, y: 1960, rx: 470, ry: 430, rot: 165, color: '#a8d89a' },
    { kind: 'ground', x: 9250, y: 2650, rx: 420, ry: 390, rot: 47, color: '#8fc97f' },
    { kind: 'ground', x: 9420, y: 1750, rx: 380, ry: 340, rot: 88, color: '#a8d89a' },
    { kind: 'canyon', x: 4200, y: 5550, rx: 520, ry: 330, rot: 8, color: '#a0522d' },
    { kind: 'canyon', x: 5100, y: 5450, rx: 560, ry: 350, rot: -14, color: '#8a3b2a' },
    { kind: 'canyon', x: 6000, y: 5600, rx: 480, ry: 320, rot: 21, color: '#a0522d' },
    { kind: 'canyon', x: 4700, y: 5750, rx: 440, ry: 260, rot: -6, color: '#b85c33' }
  ],
  obstacles: [
    { x: 2412, y: 511, r: 236 },
    { x: 2702, y: 332, r: 188 },
  ...
  sceneryObstacles: [
    // 世界变化：风车、风桥、风暴核心
    { x: 1640, y: 2420, r: 100, label: 'windmill' },
    { x: 1350, y: 2350, r: 68, label: 'windcore' },
    { x: 1850, y: 2650, r: 68, label: 'windtower' },
    { x: 8800, y: 2350, r: 75, label: 'starmill' },
    { x: 5000, y: 5550, r: 75, label: 'echoscale' },
    { x: 1720, y: 2700, r: 80, label: 'wind-bridge' },
    { x: 1170, y: 2710, r: 90, label: 'storm-core' },
    // 村庄：玩家不可直接穿过房子
    { x: 1200, y: 2400, r: 72 },
    { x: 2600, y: 3000, r: 72 },
    { x: 3400, y: 2900, r: 72 },
